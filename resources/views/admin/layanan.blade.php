                                                ...
                                                <td class="align-middle text-center">
                                                    <span class="d-flex justify-content-center">
                                                        ...
                                                        <form id="deleteForm-{{ $item->id }}" method="post"
                                                            action="{{ route('layanan.destroy', $item->id) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createUserModalLabel">Tambah Layanan</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('layanan.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="nama">Nama Layanana</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('layanan.update', $item->id) }}" method="POST">
                            ...
                            @method('PUT')
                            <div class="form-group">
                                <label for="edit_nama{{ $item->id }}">Nama Layanan</label>
                                <input type="text" class="form-control" id="edit_nama{{ $item->id }}"
                                    name="nama_layanan" placeholder="Nama Layanan" value="{{ $item->nama_layanan }}"
                                    required>
                            </div>
