...
<head>
    ...
    <!-- Bootstrap CSS File -->
    <link href="landingassets/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Libraries CSS Files -->
    <link href="landingassets/lib/nivo-slider/css/nivo-slider.css" rel="stylesheet">
    <link href="landingassets/lib/owlcarousel/owl.carousel.css" rel="stylesheet">
    <link href="landingassets/lib/owlcarousel/owl.transitions.css" rel="stylesheet">
    <link href="landingassets/lib/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="landingassets/lib/animate/animate.min.css" rel="stylesheet">
    <link href="landingassets/lib/venobox/venobox.css" rel="stylesheet">
    <script src="landingassets/js/jquery-3.5.1.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.1/jquery.waypoints.min.js"
        integrity="sha256-jDnOKIOq2KNsQZTcBTEnsp76FnfMEttF6AV2DF2fFNE=" crossorigin="anonymous"></script>
    <script src="landingassets/js\jquery.counterup.min.js"></script>

    <!-- Nivo Slider Theme -->
    <link href="landingassets/css/nivo-slider-theme.css" rel="stylesheet">
    ...
    <div id="home" class="slider-area">
        <div class="bend niceties preview-2">
            <div id="ensign-nivoslider" class="slides">
                <img src="landingassets/img/slider/pic1.jpg" alt="" title="#slider-direction-1" />
                <img src="landingassets/img/slider/pic22.jpg" alt="" title="#slider-direction-2" />
                <img src="landingassets/img/slider/pic33.jpg" alt="" title="#slider-direction-3" />
            </div>
